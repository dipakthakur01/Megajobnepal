// Legacy Supabase file - now using MongoDB
// This file is kept for backwards compatibility with type definitions only
...
// Legacy API object - replaced with MongoDB service
// Kept for backwards compatibility
export const api = {
  async getUsers() { return { data: [], error: null }; },
  async getJobs() { return { data: [], error: null }; },
  async getCompanies() { return { data: [], error: null }; },
  async getJobApplications() { return { data: [], error: null }; },
};