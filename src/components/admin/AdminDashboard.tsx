  ...
  const loadStats = async () => {
    try {
      const [
        ...
        dbService.getCollection('users').find({}),
        dbService.getCollection('jobs').find({}),
        dbService.getCollection('companies').find({}),
        dbService.getCollection('job_applications').find({}),
