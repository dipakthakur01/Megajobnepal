...
export const NewsAnnouncement: React.FC<NewsAnnouncementProps> = ({ newsItems = [] }) => {
  ...
  // Load news items from localStorage (managed by admin)
  React.useEffect(() => {
            ...
            <div className="space-y-2">
              ...
              <div className="relative aspect-video bg-gray-100 rounded-lg overflow-hidden">
                {getYouTubeEmbedUrl(featuredVideo.link) ? (
                  <iframe
                    src={getYouTubeEmbedUrl(featuredVideo.link)}
        ...
        <CardContent className="p-3 pt-0">
          <div className="space-y-1">
            <Button
              ...
              onClick={() => window.open('https://www.megajobnepal.com/jobs', '_blank')}
            >
              → Browse Jobs
            </Button>
            <Button
              ...
              size="sm"
              className="w-full justify-start text-xs p-1.5 h-auto rounded-lg"
              onClick={() => window.open('https://www.megajobnepal.com/companies', '_blank')}
            >
              → Companies
            </Button>
            <Button
              ...
              size="sm"
              className="w-full justify-start text-xs p-1.5 h-auto rounded-lg"
              onClick={() => window.open('https://www.megajobnepal.com/career-guide', '_blank')}
            >
              → Career Guide
            </Button>
          </div>
